...
`x86_64-w64-mingw32.static.posix` toolchain bundled in Rtools45) are always
downloaded automatically from the same URL.

> **Windows limitation:** The Rtools45 `static.posix` sysroot does not
> provide `netcdf` or `libproj`. Consequently, the following VTK modules are
